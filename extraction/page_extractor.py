...
def _penalise_proxy(proxy_url: str, canonical_url: str):
    try:
        from pillar3.network.proxy_manager import get_proxy_manager
...
def fetch_page(url: str):
    ...
    from pillar3.network.robots import RobotsChecker
    from pillar3.network.frontier import get_frontier
