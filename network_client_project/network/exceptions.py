...
class ErrorDetector:
    ...
    def detect_waf_or_captcha(response: requests.Response) -> Optional[Exception]:
        ...
        if "text/html" in content_type:
            ...
            # Menlo Security isolation proxy intercept
            if "safeview-static" in html or "menlo.gutsenv.net" in html or "<title>secureweb</title>" in html:
                return ProxyBannedError("Menlo Security safeview proxy intercept detected.")
