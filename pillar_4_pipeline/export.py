...
from database.connection import setup_database as _core_setup_database

def setup_database(cursor):
    """Initializes canonical flowiz_leads schema using database.connection."""
    _core_setup_database(cursor)
